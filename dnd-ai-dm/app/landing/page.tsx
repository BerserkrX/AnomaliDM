      ...
      <main className="h-[calc(100vh-4rem)] overflow-y-auto bg-background text-foreground flex flex-col items-center justify-start px-4 pt-6 pb-16">
        ...
        <section id="features-details" className="flex flex-col gap-12 w-full max-w-4xl lg:w-2/3 mx-auto mb-16">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            <img src="/images/play-without-dm.png" alt="Play Without a DM" className="w-96 h-96 object-contain mb-4 md:mb-0" />
            <div className="md:text-left text-center">
              <h2 className="text-3xl font-bold mb-2">Play Without a DM</h2>
              <p className="text-lg text-muted-foreground">
                Whether you’re down a Dungeon Master, taking a break, or you're the forever-DM who never gets to play, Anomali has your back.
                ...
                Anomali becomes your Game Master — available 24/7, never burned out, always in character.
                Finally, you can enjoy the thrill of discovery from the player’s side of the table — without sacrificing narrative depth or structure.
              </p>
            </div>
          </div>
          {/* 2nd feature: text left, image right */}
          <div className="flex flex-col md:flex-row-reverse items-center gap-6">
            <img src="/images/cinematic-storytelling.png" alt="Cinematic Storytelling" className="w-96 h-96 object-contain mb-4 md:mb-0" />
            <div className="md:text-right text-center">
              <h2 className="text-3xl font-bold mb-2">Cinematic Storytelling</h2>
              <p className="text-lg text-muted-foreground">
                Tabletop RPGs are at their best when the story pulls you in, and that’s exactly what Anomali is built to do.
                Our AI Dungeon Master creates immersive environments, dynamic characters, and tone-driven narratives tailored to your party’s actions.
                ...
                It won't matter if you want dark and gritty or whimsical and wild, every session will feel like an epic tale worth remembering.
              </p>
            </div>
          </div>
          {/* 3rd feature: image left, text right */}
          <div className="flex flex-col md:flex-row items-center gap-6">
            <img src="/images/living-worlds.png" alt="Living Worlds" className="w-96 h-96 object-contain mb-4 md:mb-0" />
            <div className="md:text-left text-center">
              <h2 className="text-3xl font-bold mb-2">Living Worlds</h2>
              <p className="text-lg text-muted-foreground">
                Anomali doesn’t just generate one-shot adventures, it builds worlds that evolve with your group.
                ...
                This is more than a game session. It’s a persistent, evolving narrative universe shaped entirely by your party’s decisions.
              </p>
            </div>
          </div>
        </section>
