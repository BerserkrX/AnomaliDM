...
export const spellsData: Spell[] = [
  ...
  },
  {
    ...
    components: "V, S",
    duration: "1 Round",
    description: "An invisible barrier of magical force appears and protects you. Until the start of your next turn, you have a +5 bonus to AC, including against the triggering attack, and you take no damage from magic missile.  * - which you take when you are hit by an attack or targeted by the magic missile spell",
    classes: ["Sorcerer", "Wizard"]
  },
  {
